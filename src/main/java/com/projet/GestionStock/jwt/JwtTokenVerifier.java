package com.projet.GestionStock.jwt;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            try {
                ...
                UserDetails curentUser = serviceUtilisateur.loadUserByUsername(username);
            ...
            Set<SimpleGrantedAuthority> simpleGrantedAuthorities = ((Collection<Map<String, String>>) authorities).stream()
